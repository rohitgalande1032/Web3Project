    ...
    <div className='flex w-full justify-center items-center'>
      <div className='flex mf:flex-row flex-col items-start justify-center md:p-20 py-12 px-4'>
        <div className='flex flex-1 justify-start flex-col mf:mr-10'>
          ...
          {/* If there is current account there is no need of render button. if our account is conneced we
          shouldn't be able to see this button */}
          {!currentAccount && (
          <button type='button'
        ...
        <div  className='flex flex-col flex-1 items-start justify-start w-full mf:mt-0 mt-10'>
          <div className='p-3 justify-start items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism'>
